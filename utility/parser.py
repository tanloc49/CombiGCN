...
def parse_args():
    parser = argparse.ArgumentParser(description="Run CombiGCN.")
    ...
    parser.add_argument('--dataset', nargs='?', default='foursquare',
                        help='Choose a dataset from {ciao, epinions, foursquare}')
